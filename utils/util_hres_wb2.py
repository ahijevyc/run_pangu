...
class IFSHRESUpscaler:
    ...
    def hres_upscale_forecast(self, datasource, upscaled_model_fields, upscaled_derived_fields, get_date, fhr):
        ...
        try:
            ...
            for var_name, abbr in variable_mapping.items():
                if abbr in ['msl', 'u10m', 'v10m', 't2m', 'sp', 'tp']:
                    # Surface variables
