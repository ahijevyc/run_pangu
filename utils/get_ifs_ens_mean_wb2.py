__all__ = ['WB2_IFSENS_MEAN_Datasource']
import warnings
...
class WB2_IFSENS_MEAN_Datasource:
    start_lat: float
    end_lat: float
    start_lon: float
    end_lon: float
    ...
    def __post_init__(self):
        url = 'gs://weatherbench2/datasets/ifs_ens/2018-2022-1440x721_mean.zarr'
        self.ds = xr.open_zarr(fsspec.get_mapper(url), chunks=None)
...
if __name__ == '__main__':
    weather_source = WB2_IFSENS_MEAN_Datasource(
        start_lat=20,
        end_lat=56,
        start_lon=-132,
        end_lon=-60,
