...
class GFSUpscaler:
    ...
    def gfs_upscale_forecast(self, datasource, upscaled_model_fields, upscaled_derived_fields, get_date, fhr):
        ...
        try:
            ...
            for f in this_upscaled_derived_fields.keys():
                if f == 'LR75':
                    ...
                    ht700 = ds.isel(time=0).sel(channel='z700').values/9.80665
