__all__ = ['WB2_IFSHRES_Datasource']
...
class WB2_IFSHRES_Datasource:
    ...
    def __post_init__(self):
        url = "gs://weatherbench2/datasets/hres/2016-2022-0012-1440x721.zarr"
...
if __name__ == '__main__':
    weather_source = WB2_IFSHRES_Datasource(
        start_lat=20,
        end_lat=52,
        start_lon=-128,
        end_lon=-64,
