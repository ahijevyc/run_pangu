...
python inference_to_nc_iterative_gfs.py --start_date 20240501 --end_date 20240501 --inference_input_dir pangu_gfs_input_data --inference_output_dir pangu_gfs_forecast_data
